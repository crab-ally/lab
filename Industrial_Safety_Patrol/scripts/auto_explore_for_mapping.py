...
class AutoExploreNode(Node):
    def __init__(self):
        ...
        self.raw_world_waypoints=[
            ...
            (-9.4,-9.0,1.5),      # Workbench 외곽 우회
            (-9.4,-6.5,1.5),      # 서쪽 외벽 스캔
            (-7.0,-6.5,1.0),      # 남서쪽 작업 영역
            (-7.0,-9.0,2.0),      # 남쪽 외곽
            ...
            (-1.0,-9.0,1.0),      # 남쪽 외곽
            (3.0,-9.0,1.0),       # 남쪽 외곽
            (5.0,-8.5,1.0),       # SE 화물 접근
            (5.0,-8.0,2.0),       # [FIRE 1] 화재 관측

            # =========================================================================
            # 3. Utility room 우회
            # =========================================================================
            (5.0,-5.5,1.0),       # Utility 서쪽 우회
            (5.0,-5.0,1.0),       # Utility 북서쪽
            (7.0,-5.0,1.0),       # Utility 북쪽 통과
            (9.0,-5.0,1.0),       # 동쪽 영역
            (9.0,-3.0,1.0),       # 동쪽 외벽
            (5.0,-3.0,1.0),       # 중앙-동쪽
            (2.0,-3.0,1.0),       # 중앙
            ...
            (-9.0,3.0,1.0),       # 서쪽 외벽
            (-9.0,5.0,1.0),       # 서북쪽 외벽
            (-8.5,7.0,1.0),       # NW 지게차 접근
            (-6.5,7.0,2.0),       # NW 지게차 관측
            (-4.0,7.0,1.0),       # 북서쪽 영역
            (-2.0,7.0,1.0),       # 북쪽 중앙
            (0.0,7.0,1.0),        # 북쪽 중앙
            (0.0,3.5,1.0),        # 중앙 통로
            ...
            # 5. 1사분면 / NE 영역
            # =========================================================================
            (3.0,3.0,1.0),        # 중앙-NE 영역
            (5.0,3.0,2.0),        # 파렛트 랙 관측
            (7.5,3.0,1.0),        # 동쪽 영역
            (8.5,5.0,1.0),        # 동쪽 영역
            (8.5,7.0,1.0),        # NE 영역
            (6.5,7.0,1.0),        # 파렛트 랙 주변
            (4.0,7.0,2.0),        # NE 지게차 관측
            (4.0,9.5,1.0),        # 북쪽 외곽
            (1.0,9.5,1.0),        # 북쪽 외곽
            (-2.0,9.5,1.0),       # 북쪽 외곽
            (-4.5,9.5,1.0),       # 북쪽 외곽
            ...
            # =========================================================================
            (9.0,-5.0,1.0),       # 동쪽 영역
            (7.0,-5.0,1.0),       # Utility 북쪽
            (5.0,-5.0,1.0),       # Utility 우회
            (3.0,-5.0,2.0),       # 중앙 남쪽
            (0.0,-5.0,1.0),       # column_6/7 회피
            (-3.0,-5.0,2.0),      # 컨베이어 관측
            (-6.0,-5.0,2.0),      # SW 작업 영역
            (-9.0,-5.0,1.0),      # 서쪽 외벽
            (-9.4,-8.5,1.0),      # Workbench 외곽 우회
            (-9.5,-9.5,5.0)       # [HOME] 최종 귀환
        ]
        self.waypoints = []
        self.waypoint_idx = 0
