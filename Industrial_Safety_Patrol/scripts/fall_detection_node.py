...
class FallDetectionNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info(
            ...
            f'{self.KEYPOINT_CONF_THRESHOLD}'
        )

        self.get_logger().info(
            f'Horizontal angle threshold: '
            f'{self.HORIZONTAL_ANGLE_THRESHOLD} deg'
        )
    ...
    def calculate_geometry(self, kpt):
        ...
        geometry_fall = (
            shoulder_hip_angle
            <= self.HORIZONTAL_ANGLE_THRESHOLD
            and
            hip_knee_angle
            <= self.HORIZONTAL_ANGLE_THRESHOLD
        )
        ...
        if results and len(results) > 0:
            ...
            if (
                ...
                for i in range(len(xyxy)):
                    ...
                    if (
                        track_id
                        not in self.initial_fall_votes
                    ):
